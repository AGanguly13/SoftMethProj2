...
/** This goes in the GymManager class for the LM command
...
/** This goes in the GymManager class for the A command to add a standard member
 *  Calls the new standard member constructor in the member class
 *  No longer checks expiration date since that is default set to 3 months in future
 *  This may have to replace the old A command
private void addStandardMember(String input) {
    ...
    if (!validCity) {
        ...
        Member newEntry = new Member(firstname, lastname, dateOfBirth, city);
...
/** This goes in the GymManager class for the AF command to add a standard member
 *  Calls the family member constructor in the family class
 *  No longer checks expiration date since that is default set to 3 months in future
...
/** This goes in the GymManager class for the AP command to add a premium member
 *  Calls the family member constructor in the family class
 *  No longer checks expiration date since that is default set to 3 months in future
private void addFamilyMember(String input) {
    String firstname = input.split(" ")[0];
